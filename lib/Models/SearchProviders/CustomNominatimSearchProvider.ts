...
export default class CustomNominatimSearchProvider extends LocationSearchProviderMixin(
  CreateModel(NominatimSearchProviderTraits)
) {
  static readonly type = "custom-nominatim-search-provider";

  get type() {
    return CustomNominatimSearchProvider.type;
  }
...
function createZoomToFunction(
  model: CustomNominatimSearchProvider,
